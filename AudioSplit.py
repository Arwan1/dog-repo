...
def split_wav(input_file, output_folder, split_duration):
    ...
    for i in range(num_chunks):
        ...
        output_file = os.path.join(output_folder, f"Market_Bazaar_Sounds_{i}.wav")
        chunk.export(output_file, format="wav", codec="pcm_s16le")

if __name__ == "__main__":
    input_file = "Market Bazaar Sounds.wav"
